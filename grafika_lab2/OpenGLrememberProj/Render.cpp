...
void Render(OpenGL* ogl)
{
	...
	GLfloat amb[] = { 0.9, 0.8, 0.1, 1. };
	GLfloat dif[] = { 0.4, 0.25, 0.5, 1. };
	GLfloat spec[] = { 0.9, 0.1, 0.3, 1. };
	GLfloat sh = 0.1f * 256;
	...
	GLdouble* normal = crossProduct(B, C, H);
	...
	for (double i = -0.4; i <= 0.61; i += 0.001)						
	{
		double x = 8 + sqrt(40) / 2 * cos(i * 3.141593);
		...
		Det[0] = { x - (8 + sqrt(40) / 2 * cos((i - 0.0001) * 3.141593)) };
		Det[1] = { y - (6 + sqrt(40) / 2 * sin((i - 0.0001) * 3.141593)) };
